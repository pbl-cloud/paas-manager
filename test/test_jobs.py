...
class TestJobs(unittest.TestCase):
    ...
    def test_status_finished(self):
        self.jobs.update_output(self.jobid, 'stdout', 'stderr')
        self.assertEqual(self.jobs.status_of(self.jobid), self.jobs.FINISHED)

    def test_start_job(self):
        self.assertEqual(self.jobs.status_of(self.jobid), self.jobs.WAITING)
        self.jobs.start_job(self.jobid)
        self.assertEqual(self.jobs.status_of(self.jobid), self.jobs.RUNNING)
